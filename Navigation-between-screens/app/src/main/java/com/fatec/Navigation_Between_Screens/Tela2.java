...
public class Tela2 extends AppCompatActivity {
    ...
    public void init() {
        ...
        if (getIntent().hasExtra("vl_extra")) {
            ...
            TextView txtScore = findViewById(R.id.txtScoreT2);
        ...
        if (background != 0) {
            ...
            layout2.setBackgroundColor(background);
        }
        else {
    ...
    public void voltarTP(View view) {
        in = new Intent(Tela2.this, MainActivity.class);
        in.putExtra("vl_extra", score);
        startActivity(in);
    }

    public void avancarT3(View view) {
        in = new Intent(Tela2.this, Tela3.class);
        in.putExtra("vl_extra", score);
        startActivity(in);
    }

    public int getColor() {
        ConstraintLayout mainLayout = findViewById(R.id.layout2);
